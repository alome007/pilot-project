...
export default function Hero({ onLogin }: HeroProps) {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-transparent dark:from-gray-900 dark:to-gray-900/95 overflow-hidden">
      <button
        onClick={toggleDarkMode}
        className="fixed top-4 right-4 p-2 rounded-lg bg-white/80 dark:bg-gray-800/80 hover:bg-gray-100 dark:hover:bg-gray-700/80 transition-colors z-10"
      >
        {isDark ? (
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="max-w-xl mx-auto lg:mx-0 text-center lg:text-left space-y-8 lg:space-y-10">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600/5 dark:bg-blue-500/10 rounded-full text-blue-600 dark:text-blue-400 text-sm font-medium"
            >
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-gray-900 dark:text-white tracking-tight leading-[1.1]">
                Your emails,{' '}
                <span className="inline-flex flex-col relative">
                  <span className="relative text-blue-600 dark:text-blue-400">
                    truly private
                    <div className="absolute bottom-1 left-0 h-3 w-full bg-blue-100/50 dark:bg-blue-500/20 -z-10 -rotate-1" />
                  </span>
                </span>
              </h1>
            ...
            >
              <button
                ...
                className="group inline-flex items-center justify-center px-5 py-2 bg-blue-600 text-white 
                         font-medium rounded-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600
                         transition-all duration-200 transform hover:-translate-y-0.5 w-full sm:w-auto"
              >
                Get started
          ...
          >
            ...
            <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-6 lg:p-8 shadow-xl">
